...
**Domain:** Agriculture support and scheme navigation  
...
Farmers may not know which subsidies or advisory services apply to them. Build an agent that asks farm details, checks a local scheme/advisory document set, and creates a simple action checklist.
...
Build a working solution for **Farmer Subsidy and Advisory Navigation Agent** that takes relevant input data, processes it through a clear workflow, and produces an actionable output for real users or decision-makers.
...
Scheme/advisory RAG, eligibility matching, document checklist, regional language-friendly explanation.
...
**Dataset / Reference Name:** Data.gov.in agriculture datasets / scheme notes

**Link:** https://www.data.gov.in/keywords/agriculture

**How to Use It:**
Use agriculture scheme notes or sample advisory documents; create farm_profile.csv and scheme_rules.csv.
